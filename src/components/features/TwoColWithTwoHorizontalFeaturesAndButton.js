...
export default ({
  ...
  description = "La confiance est crucial pour établir des liens solides et une communication efficace. Cela simplifie la prise de décisions et renforce la cohésion dans les équipes. Des valeurs communes sont la clé d'une collaboration harmonieuse et réussie.",
